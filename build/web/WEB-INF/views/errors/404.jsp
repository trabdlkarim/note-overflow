<%-- 
    Document   : 404
    Created on : Feb 25, 2019, 7:28:29 PM
    Author     : trabdlkarim
--%>
...
<head>
  ...
  <title>Note Overflow - 404 Page Not Found</title>
  <meta name="viewport" content="width=device-width">
  <link rel="shortcut icon" href="/noteoverflow/assets/img/logo_sm.png">
  <!--[if gte IE 9]>
	<style type="text/css">
		.gradient {
		   filter: none;
...
<body style="overflow:hidden;">
	...
	<div class="error-page-wrap">
		<article class="error-page gradient">
			<hgroup>
				<h1>404</h1>
				<h2>oops! sayfa bulanmamış</h2>
			</hgroup>
                    <a href='#' onclick="window.history.back()" 
                       title="Önceki sayfaya dön" 
                       class="error-back"> Geri dön </a>
		</article>
	</div>
</body>
</html>