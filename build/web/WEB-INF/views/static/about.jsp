...
<%@page import="com.noteoverflow.models.UserJDBCTemplate"%>
<%@page import="org.springframework.context.ApplicationContext"%>
<%@page import="org.springframework.context.support.ClassPathXmlApplicationContext"%>
<%@page import="com.noteoverflow.models.User"%>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="<c:url context="/noteoverflow" value='/index.htm'/>">${systemName} | ${systemVersion}</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <% ApplicationContext context = new ClassPathXmlApplicationContext("beans.xml");
                     ...
                     <p><% out.print("ID : " + record.getId() );
                           out.print(", Name : " + record.getName() );
                           out.println(", Surname : " + record.getSurname());%></p>
                   <%}%>
                </div>
                <!-- /.row -->
            </div>
