            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="profile.htm"><i class="fa fa-user fa-fw"></i> Profile</a>
                        </li>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="notes.htm"><i class="fa fa-tasks fa-fw"></i> Lecture Notes<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.htm">Private Notes</a>
                                </li>
                                <li>
                                    <a href="flot.htm">Shared Notes</a>
                                </li>
                                <li>
                                    <a href="morris.htm">Public Notes</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        <li>
                            <a href="tables.htm"><i class="fa fa-group fa-fw"></i> Connections</a>
                        </li>
                        <li>
                            <a href="flot.htm"><i class="fa fa-bar-chart-o fa-fw"></i> Statistics</a>
                        </li>
                        <li>
        ...
        <div id="page-wrapper">
                ...
                <div class="col-lg-6">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <strong>Add Lecture Notes</strong>
                        </div>
                        <!-- /.panel-heading -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myUploadModalLabel">Add Lecture Notes</h4>
                                        </div>
                            ...
                            <div class="modal fade" id="timeline" tabindex="-1" role="dialog" aria-labelledby="myTimelineLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                            <h4 class="modal-title" id="myTimelineLabel">Activities Timeline</h4>
                                        </div>
                                        <div class="modal-body">
                                            <div class="panel panel-default">
                                                <div class="panel-heading">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-group fa-fw"></i> Favourites Connections
                        </div>
                        <!-- /.panel-heading -->
                        <div class="panel-body">
                            ...
                            <!-- /.list-group -->
                            <a href="#" class="btn btn-default btn-block">View All Connections</a>
                        </div>
                        <!-- /.panel-body -->
                    </div>
                    <!-- /.panel -->
