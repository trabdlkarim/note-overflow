                        ...
                        <div class="panel">
                                ...
                                <div class="panel-controls">
                                    <ul class="nav nav-tabs" role="tablist">
                                        <li role="presentation" class="active">
                                            <a href="http://vtdes.ru/demo/caspero/#fast-actions-pending" aria-controls="fast-actions-pending" role="tab" data-toggle="tab">Pending</a>
                                        </li>
                                        <li role="presentation">
                                            <a href="http://vtdes.ru/demo/caspero/#fast-actions-completed" aria-controls="fast-actions-completed" role="tab" data-toggle="tab">Completed</a>
                                        </li>
                                    </ul>
                                </div>
                                <!-- Panel controls -->
                            ...
                            <div class="panel-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div id="fast-actions-pending" role="tabpanel" class="tab-pane fade in active">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table no-mb">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="strong text-dark">Deborah Young</div>
                                                        <p class="no-mb">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="strong text-dark">Louis Hawkins</div>
                                                        <p class="no-mb">
                                                            The standard chunk of Lorem Ipsum used since the 1500s.
                                                        </p>
                                                    </td>
                                    ...
                                    <div id="fast-actions-completed" role="tabpanel" class="tab-pane fade">
